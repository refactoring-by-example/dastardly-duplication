...
async function getProductData() {
    const productRetries = 3;
    const requests = {
        book: get(metadataHost + '/books', { retries: productRetries }),
        dvd: get(metadataHost + '/dvds', { retries: productRetries }),
        'blu-ray': get(metadataHost + '/bluerays', { retries: productRetries }),
        'vinyl-record': get(metadataHost + '/vinyls', { retries: productRetries })
    };
